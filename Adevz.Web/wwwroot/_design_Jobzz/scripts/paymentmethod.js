...
function ShowContractorBillingInformation(ContractorBillingInfo)
{
    if(ContractorBillingInfo != null)
    {
        ...
        document.getElementById("CardNumberTextBox").value = ContractorBillingInfo.CreditCardNumber;
       ...
       success:
         function (Result)
         {
                 ...
                 UpdatedJobzzMember.MemberId != "00000000-0000-0000-0000-000000000000")
             {
                 ...
                 alert("Your billing information were successfully updated. You can now order workers for your tasks.");
